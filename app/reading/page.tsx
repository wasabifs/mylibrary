      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 10 }}>
            ...
            <span style={{ fontSize: 10, color: '#9a9080', letterSpacing: '0.2em', textTransform: 'uppercase' }}>Reading</span>
          </div>
          <SyncButton />
        </div>
      </div>
            ...
            return (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 5 }}>
                  ...
                  {book.subtitle && (
                    <div style={{ fontSize: 12, color: '#9a9080', lineHeight: 1.4 }}>{book.subtitle}</div>
                  )}
